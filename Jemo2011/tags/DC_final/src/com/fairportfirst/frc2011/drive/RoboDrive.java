...
public class RoboDrive extends IterativeRobot {
    ...
    private Jaguar leftBackJag;
    private Jaguar rightFrontJag;
    private Jaguar rightBackJag;
...
//        try {//CANbus init and drive init
            leftFrontJag = new Jaguar(2);
            leftBackJag = new Jaguar(5);
            rightFrontJag = new Jaguar(3);
            rightBackJag = new Jaguar(4);
